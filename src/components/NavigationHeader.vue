      ...
      <div class="flex flex-col items-center md:items-end gap-4 md:gap-6 w-full md:w-auto">
        ...
        <div class="flex items-center gap-3 sm:gap-4 w-full">
          ...
          <button
            ...
            class="flex-shrink-0 relative group bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white p-3 sm:p-4 rounded-xl sm:rounded-2xl font-medium flex items-center justify-center shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500 dark:focus-visible:ring-offset-gray-900 overflow-hidden"
            aria-label="设置"
          >
            <!-- 按钮内部光效 -->
            ...
            <!-- 设置图标 (齿轮) -->
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 relative z-10 group-hover:rotate-90 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
